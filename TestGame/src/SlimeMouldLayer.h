...
class SlimeMouldLayer : public Arkitect::Layer
{
public:
	SlimeMouldLayer();

	~SlimeMouldLayer() = default;
...
private:
	...
	float m_AgentSpeed = 3.0;
	float m_SensorArmLength = 15.0;
	float m_SensorAngle = (2 * 3.14156) * (1.0 / 3.0);
	float m_RotationAngle = m_SensorAngle / 6.0;
	float m_DecayRate = 260.0;
